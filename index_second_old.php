...
<div class="container-fluid support-section mt-3 pt-3 pb-3">
    <div class="container">
      ...
      <div class="container mt-4">
        ...
        <button type="button" class="callback-btn rounded  blinking-shadow-btn" data-bs-toggle="modal" data-bs-target="#callbackModal">Request Call Back <i class="fas fa-phone-alt"></i></button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Request a Call Back</h5>
                    <button type="button" class="btn-close text-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Kindly complete the form below, and one of our representatives will reach out to you promptly upon receiving your submission.</p>
                    <form id="callbackForm" class="needs-validation" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="city" class="form-label fw-bold">City/Country</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success wave-glow" form="callbackForm" >Submit</button>
                </div>
            </div>
        </div>
    </div>
