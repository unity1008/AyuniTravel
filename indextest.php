...
<!-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
  <a class="navbar-brand" href="">Ayuni Travels</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">Umrah Calculator</a>
          <a class="dropdown-item" href="#">Umrah Packages</a>
          <a class="dropdown-item" href="#">Best Umrah Packages</a>
          <a class="dropdown-item" href="#">Child Umrah Visa</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">Umrah Transport Services</a>
          <a class="dropdown-item" href="#">Umrah Calculator</a>
          <a class="dropdown-item" href="#">Umrah Packages</a>
          <a class="dropdown-item" href="#">Best Umrah Packages</a>
          <a class="dropdown-item" href="#">Child Umrah Visa</a>
      ...
      <div class="container">
        <div class="row">
            ...
            <h2 class="custom-heading d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-info border " data-bs-toggle="modal" data-bs-target="#mapModal">
            ...
            <div class="modal fade modal-dialog modal-fullscreen-sm-down" id="mapModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d414.6149947162263!2d72.77062343325024!3d33.76273418250774!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38dfa750bb279a9f%3A0xc201923b55bd767a!2sAyuni%20Tech%20Services!5e0!3m2!1sen!2s!4v1741242563520!5m2!1sen!2s" 
                                    width="600" 
                                    height="450" 
                                    style="border:100;" 
                                    allowfullscreen="" 
      ...
      <div class="container mt-4">
          <div class="info-card">
              ...
              <p class="info-text">
                  ...
                  <br> <br> 2.<strong>  <?= $translations['Visa Assistance:'] ?></strong> <br><?= $translations['p3'] ?>
                  
                  <br> <br>3. <strong>    <?= $translations['Hotel Reservations:'] ?>  </strong> <br><?= $translations['p4'] ?>
                  
                   <br> <br> 4. <strong>  <?= $translations['Car Rentals:'] ?>  </strong> <br><?= $translations['p5'] ?>
                   <br>  <br>  <br> 
              <p class="info-text">
                  <div class="col-lg-12">
                    <div class="col-lg-4">
        ...
        <button type="button" class="callback-btn rounded  blinking-shadow-btn" data-bs-toggle="modal" data-bs-target="#callbackModal"><?= $translations['Request Call Back'] ?> <i class="fas fa-phone-alt"></i></button>
                    ...
                    <form id="callbackForm" class="needs-validation" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="invalid-feedback">Enter your city or country.</div>
                            </div>
                            <div class="col-12">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#"><?= $translations['Flights'] ?></a></li>
                    <li><a href="#"><?= $translations['about'] ?></a></li>
                    <li><a href="#"><?= $translations['Travel Agency'] ?></a></li>
                    <li><a href="#"><?= $translations['Privacy Policy'] ?></a></li>
                    <li><a href="#"><?= $translations['Refund Policy'] ?></a></li>
            ...
            <!-- <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                    <li><a href="#"><?= $translations['Wah Cantt'] ?></a></li>
                    <li><a href="#"><?= $translations['Attock'] ?></a></li>
                </ul>
            </div> -->
            ...
            <!-- <div class="col-md-3">
                ...
                <p>
                    <i class="bi bi-telephone-plus-fill"></i> +92 51 111 222 333 <br>
                    <i class="bi bi-envelope-at-fill"></i> info@ayunitravel.com <br>
